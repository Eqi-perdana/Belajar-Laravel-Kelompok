                    ...
                    <div class="card-body">
                        <form action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold" style="color:rgb(250, 37, 0);">GAMBAR</label>
                                <input type="file" class="form-control" name="image">
                            </div>

                            <div class="form-group">
                                <label class="font-weight-bold" style="color:rgb(250, 37, 0);">JUDUL</label>
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold" style="color:rgb(250, 37, 0);">KONTEN</label>
